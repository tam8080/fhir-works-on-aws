...
const attributeGroupName: string = app.node.tryGetContext('attributeGroupName');
const applicationType: string = 'AWS-Solutions';
const appRegistryApplicationName: string = app.node.tryGetContext('appRegistryApplicationName');
